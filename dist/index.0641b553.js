...
const jobSearch = new _jobSearch.JobSearch('#search-form', '.result-container', '.loading-element');
...
class JobSearch {
    ...
    setCountryCode() {
        ...
        fetch('http://ip-api.com/json').then((results)=>results.json()
        ).then((results)=>{
    ...
    configureFormListener() {
        this.searchForm.addEventListener('submit', (event)=>{
            ...
            fetch(`http://localhost:3000/?search=${search}&location=${location}&country=${this.countryCode}`).then((response)=>response.json()
            ).then(({ results  })=>{
                this.stopLoading();
                return results.map((job)=>_template.jobTemplate(job, this.currencySymbol)
                ).join('');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./template":"iBEJI","./utils":"en4he"}],"gkKU3":[function(require,module,exports) {
...
<div class="card">
  ...
  <a href="${job.redirect_url}">View Job</a><i class="far fa-heart-circle"></i>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequire8d29")
